...
def build_system_prompt() -> str:
    ...
    return (
        ...
        '- als een stap over betalen gaat, gebruik je action_type "betalen" en een ag-ui formulier met submit_label "Betalen"; dit is alleen een demo-knop zonder echte betaalafhandeling\n'
