...
def _build_react_prompt(
    ...
    return (
        ...
        'Recente observaties uit vorige acties:\n'
        f'{json.dumps(observations[-16:], ensure_ascii=False, indent=2)}\n\n'
        'Kies de volgende beste actie door één of meer tools aan te roepen. '
        'Herhaal geen acties die al gelukt zijn, behalve als een observatie een fout laat zien. '
        'Voortgang is geen inhoudelijke actie: roep emit_progress niet als enige tool aan. '
        'Als je zegt dat je een bron controleert, roep dan in dezelfde beurt de bijpassende discover_api, call_api of call_a2a_agent tool aan. '
        'Voortgangsteksten zijn neutrale Nederlandse tekst voor burgers, bijvoorbeeld "Controle bij RDW: voertuiggegevens ophalen." '
        'Noem nooit AI, agents, tools, OpenAPI of eerste persoon zoals "Ik controleer bij ...". '
        'Zodra een proces is geregistreerd of als irrelevant is gemarkeerd, is de broncontrolefase gesloten: roep daarna geen broncontroletools meer aan. '
        'Ieder actief proces moet precies één keer verantwoord zijn: gebruik register_process als het relevant is, of mark_process_irrelevant als het niet geldt. '
        'Processen met skip=true zijn niet actief en controleer je niet. '
        'Processen met demo_always_relevant=true registreer je als relevant zonder externe toepasselijkheidscheck. '
        'Als alle actieve processen verantwoord zijn, roep je complete_discovery aan.'
    )
